...
<html lang="en">
  <head>
    ...
    <title> MAN 2 Situbondo-Madrasah Hebat </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">MAN 2 SITUBONDO</font></span></a>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Dashboard <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-gear"></i> Jadwal Pelajaran <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Tampil Data</a></li>
                      <li><a href="#">Tambah Data</a></li>
                    </ul>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/user.png" alt="">Dwi Agustina
                  </a>
